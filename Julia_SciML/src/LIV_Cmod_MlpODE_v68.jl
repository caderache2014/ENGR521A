# ============================================================================
# MlpODE_v62.jl — Pure neural ODE for plasma current and inductance
...
# LIV_Cmod_RomeroNN_v62.jl, which implements the physics-informed
...
CSV.write("loss_history_MlpODE_v68.csv", loss_df)
println("Saved training loss history to loss_history_MlpODE_v68.csv")
...
println("Saved validation loss history to val_loss_history_MlpODE_v68.csv")
...
plot!(plt_loss, val_df.iter, val_df.val_loss,
      ...
      seriestype = :scatter,
      ms    = 4)
savefig(plt_loss, "loss_history_MlpODE_v68.png")
println("Saved loss-history plot to loss_history_MlpODE_v68.png")
...
CSV.write("predictions_MlpODE_v68.csv", results_df)
println("Saved diagnostic predictions to predictions_MlpODE_v68.csv")
...
CSV.write("MlpODE_predictions_hard_shot_v68.csv", hard_df)
println("Saved hard-shot evaluation to MlpODE_predictions_hard_shot_v68.csv")
...
savefig(plt_li, "li_MlpODE_comparison_v68.png")
...
savefig(plt_ip, "ip_MlpODE_comparison_v68.png")
...
savefig(plt_V, "V_MlpODE_comparison_v68.png")
