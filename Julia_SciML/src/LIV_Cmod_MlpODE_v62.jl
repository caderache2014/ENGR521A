...
mlp_NN = Lux.Chain(
    ...
    Lux.Dense(32, 3, x -> T(5.0) * tanh(x))   # 3 outputs, all bounded
)
...
CSV.write("predictions_MlpODE_v62.csv", results_df)
println("Saved diagnostic predictions to predictions_MlpODE_v62.csv")
...
CSV.write("MlpODE_predictions_hard_shot_v62.csv", hard_df)
println("Saved hard-shot evaluation to MlpODE_predictions_hard_shot_v62.csv")
...
savefig(plt_li, "li_MlpODE_comparison_v62.png")
...
savefig(plt_ip, "ip_MlpODE_comparison_v62.png")
...
savefig(plt_V, "V_MlpODE_comparison_v62.png")
