# ============================================================================
# vdot_diagnostic_RomeroNN_v70.jl
#
# RomeroNN_v70 version of the V_dot correlation diagnostic. Mirrors
# vdot_diagnostic_v1.jl (RomeroNN_v69) and vdot_diagnostic_MlpODE_v1.jl
# almost verbatim. Only the input/output filenames change.
#
...
#   derivatives_RomeroNN_v70.csv     (from recover_romeroNN_v70.jl)
#
# Outputs (written to wang_model_workspace/):
#   vdot_diagnostic_summary_RomeroNN_v70.csv
#   vdot_diagnostic_perpoint_RomeroNN_v70.csv
#   vdot_diagnostic_pershot_RomeroNN_v70.csv
#   vdot_pathological_shots_RomeroNN_v70.csv
#
# Run from src/:
#   julia --project=.. vdot_diagnostic_RomeroNN_v70.jl 2>&1 | tee ../vdot_diagnostic_RomeroNN_v70.log
# ============================================================================
...
# CONFIG
# ============================================================================
const DERIVATIVES_CSV = "../derivatives_RomeroNN_v70.csv"

const SUMMARY_OUT      = "../vdot_diagnostic_summary_RomeroNN_v70.csv"
const PERPOINT_OUT     = "../vdot_diagnostic_perpoint_RomeroNN_v70.csv"
const PERSHOT_OUT      = "../vdot_diagnostic_pershot_RomeroNN_v70.csv"
const PATHOLOGICAL_OUT = "../vdot_pathological_shots_RomeroNN_v70.csv"
...
# ============================================================================
println("\n" * "="^70)
println("=== V_dot DIAGNOSTIC HEADLINE — RomeroNN_v70 ===")
println("="^70)
...
@printf "  %-28s R² = %.4f, Pearson = %+.4f, Spearman = %+.4f, RMSE = %.3f\n" "NN-augmented (RomeroNN v70):" headline_row.R2_NN     headline_row.Pearson_NN     headline_row.Spearman_NN     headline_row.RMSE_NN
println()
...
println("\n=== Comparison reminder (v69 baselines) ===")
