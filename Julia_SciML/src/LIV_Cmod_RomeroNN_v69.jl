# ============================================================================
# RomeroNN_v69.jl — Hybrid neural ODE for plasma current and inductance
...
#      at every measured timestep across all 489 shots, at three smoothing
#      levels (s=0, 1e-4*N, 1e-3*N) for sensitivity analysis.
# ============================================================================
...
#   using BSON
#   ckpt = BSON.load("romeroNN_checkpoint_v69.bson")
...
CSV.write("fullshot_mape_TEST_RomeroNN_v69.csv", fullshot_test_df)
println("Saved per-shot full-shot MAPE (TEST) to fullshot_mape_TEST_RomeroNN_v69.csv")
...
CSV.write("endpoint_mape_TEST_RomeroNN_v69.csv", endpoint_test_df)
println("Saved per-episode endpoint MAPE (TEST) to endpoint_mape_TEST_RomeroNN_v69.csv")
...
CSV.write("derivatives_RomeroNN_v69.csv", derivatives_df)
println("Saved derivatives CSV: $(nrow(derivatives_df)) rows × $(ncol(derivatives_df)) cols → derivatives_RomeroNN_v69.csv")
...
CSV.write("predictions_RomeroNN_v68.csv", results_df)
println("Saved diagnostic predictions to predictions_RomeroNN_v68.csv")
...
CSV.write("loss_history_RomeroNN_v68.csv", loss_df)
println("Saved training loss history to loss_history_RomeroNN_v68.csv")

val_df = DataFrame(
    iter     = [vh[1] for vh in val_history],
    val_loss = [vh[2] for vh in val_history],
)
CSV.write("val_loss_history_RomeroNN_v68.csv", val_df)
println("Saved validation loss history to val_loss_history_RomeroNN_v68.csv")
...
plot!(plt_loss, val_df.iter, val_df.val_loss,
      ...
      seriestype = :scatter,
      ms    = 4)
savefig(plt_loss, "loss_history_RomeroNN_v68.png")
println("Saved loss-history plot to loss_history_RomeroNN_v68.png")
...
CSV.write("RomeroNN_predictions_hard_shot_v68.csv", hard_df)
println("Saved hard-shot evaluation to RomeroNN_predictions_hard_shot_v68.csv")
...
savefig(plt_li, "li_RomeroNN_comparison_v68.png")
...
savefig(plt_ip, "ip_RomeroNN_comparison_v68.png")
...
savefig(plt_V, "V_RomeroNN_comparison_v68.png")
